...
gain <- gains(ifelse(test.df$stats=="denied",1,0), pred.prob[,1], groups=100)

# Plot the Lift Chart
plot(c(0,gain$cume.pct.of.total*sum(test.df$stats=="denied"))~c(0,gain$cume.obs), 
     xlab="# cases", ylab="Cumulative", main="", type="l")
lines(c(0,sum(test.df$stats=="denied"))~c(0, dim(valid.df)[1]), lty=2)
```